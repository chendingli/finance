            ...
            layui.each(n, function(a, n) {
                ...
                var l = n.children && n.children.length > 0,
                    str = o(['<tr class="' + (p ? "layui-hide" : "") + '" id="' + n.id + '">', 
                        function() {
                            if (i.checkbox){
                                return '<td style="width: 20px;"><input style="display: block;" type="checkbox" name="treeGirdCheckbox" lay-skin="primary" lay-filter="*" value="' + n.id + '"/></td>';
                            }else{
                                return '<td style="width: 20px;">' + index + '</td>';
                            }
                        }(), 
                        function() {
                            var ret = ""
